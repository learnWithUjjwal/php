...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>DigiGuruInc | Dashboard</title>
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title">DigiGuru Inc | Dashboard</span>
                        </div>
          ...
          <div class="footer">
                    <p class="copyright"><a href="https://digiguruinc.com/">DigiGuru Inc </a>©</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Employee Login Panel</h4></div>
