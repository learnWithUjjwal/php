...
$sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Empsalary,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:empsalary,:status)";
...
$query->bindParam(':empsalary',$empsalary,PDO::PARAM_STR);
...
<html lang="en">
    <head>
        ...
        <meta name="author" content="digiguruinc" />
...
<input id="empsalary" name="empsalary" type="text" autocomplete="off" required>
 </div>
