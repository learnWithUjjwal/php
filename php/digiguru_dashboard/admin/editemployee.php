...
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno,Empsalary=:empsalary where id=:eid";
...
<input id="empsalary" name="empsalary" type="text"  value="<?php echo htmlentities($result->Empsalary);?>" autocomplete="off" required>
</div>
